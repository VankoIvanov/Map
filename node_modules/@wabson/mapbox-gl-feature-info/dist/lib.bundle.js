...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nfunction isEventAtCoordinates(event, coordinates) {\n  if (!event.lngLat) return false;\n  return event.lngLat.lng === coordinates[0] && event.lngLat.lat === coordinates[1];\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (isEventAtCoordinates);\n\n\n//# sourceURL=webpack://mapboxglFeatureInfo/./node_modules/@mapbox/mapbox-gl-draw/src/lib/is_event_at_coordinates.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://mapboxglFeatureInfo/./src/common.css?");
...
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://mapboxglFeatureInfo/./src/controls.css?");
...
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://mapboxglFeatureInfo/./src/modes.css?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\n    events: {\n        DRAW_MOUSE_MOVE: 'drawlinestring.mousemove'\n    }\n});\n\n//# sourceURL=webpack://mapboxglFeatureInfo/./src/constants.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"DrawNamedLineMode\": () => (/* reexport safe */ _modes__WEBPACK_IMPORTED_MODULE_1__.DrawNamedLineMode),\n/* harmony export */   \"LineStringInfoControl\": () => (/* reexport safe */ _controls__WEBPACK_IMPORTED_MODULE_0__.LineStringInfoControl),\n/* harmony export */   \"MultiLineInfoControl\": () => (/* reexport safe */ _controls__WEBPACK_IMPORTED_MODULE_0__.MultiLineInfoControl),\n/* harmony export */   \"PointInfoControl\": () => (/* reexport safe */ _controls__WEBPACK_IMPORTED_MODULE_0__.PointInfoControl)\n/* harmony export */ });\n/* harmony import */ var _controls__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controls */ \"./src/controls.js\");\n/* harmony import */ var _modes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modes */ \"./src/modes.js\");\n\n\n\n\n//# sourceURL=webpack://mapboxglFeatureInfo/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"DrawNamedLineMode\": () => (/* binding */ DrawNamedLineMode)\n/* harmony export */ });\n/* harmony import */ var _mapbox_mapbox_gl_draw_src_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @mapbox/mapbox-gl-draw/src/constants */ \"./node_modules/@mapbox/mapbox-gl-draw/src/constants.js\");\n/* harmony import */ var _mapbox_mapbox_gl_draw_src_modes_draw_line_string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @mapbox/mapbox-gl-draw/src/modes/draw_line_string */ \"./node_modules/@mapbox/mapbox-gl-draw/src/modes/draw_line_string.js\");\n/* harmony import */ var _mapbox_mapbox_gl_draw_src_lib_common_selectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @mapbox/mapbox-gl-draw/src/lib/common_selectors */ \"./node_modules/@mapbox/mapbox-gl-draw/src/lib/common_selectors.js\");\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants */ \"./src/constants.js\");\n/* harmony import */ var _common_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./common.css */ \"./src/common.css\");\n/* harmony import */ var _modes_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modes.css */ \"./src/modes.css\");\n\n\n\n\n\n\n\n\nconst DrawNamedLineMode = {};\n\nObject.assign(DrawNamedLineMode, _mapbox_mapbox_gl_draw_src_modes_draw_line_string__WEBPACK_IMPORTED_MODULE_1__[\"default\"], {\n\n    isNameRequired: false,\n    showNamePrompt: false,\n\n    onSetup: function(opts) {\n        const state = _mapbox_mapbox_gl_draw_src_modes_draw_line_string__WEBPACK_IMPORTED_MODULE_1__[\"default\"].onSetup.call(this, opts);\n        const isNameRequired = this.isNameRequired === true;\n        const featureName = opts.featureName;\n        const showNamePrompt = (opts.showNamePrompt !== undefined ? opts.showNamePrompt === true : this.showNamePrompt === true) || (isNameRequired && !featureName);\n        const extendedState = Object.assign(state, {\n            isNameRequired: isNameRequired,\n            name: featureName\n        });\n        if (showNamePrompt) {\n            this.setupNameFormControl(extendedState);\n            this.updateUIClasses({ mouse: _mapbox_mapbox_gl_draw_src_constants__WEBPACK_IMPORTED_MODULE_0__.cursors.MOVE });\n            this._ctx.ui.updateMapClasses();\n        }\n        return extendedState;\n    },\n    onStop: function(state) {\n        _mapbox_mapbox_gl_draw_src_modes_draw_line_string__WEBPACK_IMPORTED_MODULE_1__[\"default\"].onStop.call(this, state);\n        if (state.name) {\n            this._ctx.store.setFeatureProperty(state.line.id, 'name', state.name);\n        }\n        this.removeNameFormControl();\n    },\n    onMouseMove: function(state, e) {\n        _mapbox_mapbox_gl_draw_src_modes_draw_line_string__WEBPACK_IMPORTED_MODULE_1__[\"default\"].onMouseMove.call(this, state, e);\n        if (state.line.coordinates.length > 1) {\n            this.map.fire(_constants__WEBPACK_IMPORTED_MODULE_3__[\"default\"].events.DRAW_MOUSE_MOVE, {\n                feature: state.line,\n                state: state\n            });\n        }\n    },\n    clickAnywhere: function(state, e) {\n        if (state.isNameRequired === true && !state.name) {\n            return this.changeMode(_mapbox_mapbox_gl_draw_src_constants__WEBPACK_IMPORTED_MODULE_0__.modes.SIMPLE_SELECT);\n        } else {\n            this.removeNameFormControl();\n            return _mapbox_mapbox_gl_draw_src_modes_draw_line_string__WEBPACK_IMPORTED_MODULE_1__[\"default\"].clickAnywhere.call(this, state, e);\n        }\n    },\n    setupNameFormControl: function(state) {\n        this._formContainerEl = document.createElement('div');\n        this._formContainerEl.className = 'mapboxgl-draw-named-line--name-container mapboxgl-custom-control';\n        this._inputEl = document.createElement('input');\n        this._inputEl.type = 'text';\n        this._inputEl.className = 'mapboxgl-draw-named-line--name-input';\n        if (state.featureName) {\n            this._inputEl.value = state.featureName;\n        }\n        const createButton = document.createElement('button');\n        createButton.textContent = 'Create';\n        createButton.setAttribute('type', 'button');\n        createButton.addEventListener('click', () => this.onCreateButtonClick(state));\n        this._inputEl.addEventListener('keyup', (e) => this.onNameInputKeyUp(state, e));\n        this._formContainerEl.appendChild(document.createTextNode('Name:'));\n        this._formContainerEl.appendChild(this._inputEl);\n        this._formContainerEl.appendChild(createButton);\n        document.body.appendChild(this._formContainerEl);\n        this._inputEl.focus();\n    },\n    removeNameFormControl: function() {\n        if (this._formContainerEl && this._formContainerEl.parentNode) {\n            this._formContainerEl.parentNode.removeChild(this._formContainerEl);\n        }\n    },\n    startDraw: function() {\n        this.updateUIClasses({ mouse: _mapbox_mapbox_gl_draw_src_constants__WEBPACK_IMPORTED_MODULE_0__.cursors.ADD });\n        _mapbox_mapbox_gl_draw_src_modes_draw_line_string__WEBPACK_IMPORTED_MODULE_1__[\"default\"].onSetup.call(this, {});\n        this._ctx.ui.updateMapClasses();\n        this.removeNameFormControl();\n    },\n    onCreateButtonClick: function(state) {\n        const name = this._inputEl.value;\n        if (name) {\n            state.name = name;\n            this.startDraw();\n        } else {\n            this._inputEl.focus();\n        }\n    },\n    onNameInputKeyUp: function(state, e) {\n        if (_mapbox_mapbox_gl_draw_src_lib_common_selectors__WEBPACK_IMPORTED_MODULE_2__.isEnterKey(e)) {\n            const name = this._inputEl.value;\n            state.name = name;\n            this.startDraw();\n        } else if (_mapbox_mapbox_gl_draw_src_lib_common_selectors__WEBPACK_IMPORTED_MODULE_2__.isEscapeKey(e)) {\n            this.removeNameFormControl();\n        }\n    }\n});\n\n\n\n//# sourceURL=webpack://mapboxglFeatureInfo/./src/modes.js?");
...
/******/ 	self.mapboxglFeatureInfo = __webpack_exports__;
/******/ 	
/******/ })()
;